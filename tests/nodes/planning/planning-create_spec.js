...
describe('mealie-planning Node with create operation', function () {
  this.timeout(5000);
  ...
  it('should be loaded', function (done) {
    ...
    helper.load([rewiredPlanningNode, configNode], flow, function () {
      try {
        ...
        n1.should.have.property('name', 'Test Planning Create');
  ...
  it('should create a meal plan with node configuration', function (done) {
    const planData = {
      date: '2025-05-10',
      title: 'Saturday Plan',
      meals: [
    ...
    // Reset createMealPlan stub to return specific data
    mockClient.mealPlans = {
      createMealPlan: sinon.stub().resolves({
        id: 'plan-789',
        date: '2025-05-10',
        title: 'Saturday Plan',
        meals: [
    ...
    helper.load([rewiredPlanningNode, configNode], flow, function () {
      ...
      n2.on('input', function (msg) {
        try {
          ...
          msg.payload.data.should.have.property('id', 'plan-789');
          msg.payload.data.should.have.property('date', '2025-05-10');
          msg.payload.data.should.have.property('title', 'Saturday Plan');
          ...
          sinon.assert.calledOnce(mockClient.mealPlans.createMealPlan);
          sinon.assert.calledWith(mockClient.mealPlans.createMealPlan, planData);
  ...
  it('should create a meal plan with parameters from msg.payload', function (done) {
    const flow = [
      {
        id: 'server1',
        type: 'mealie-server-config',
      ...
      },
      {
        ...
        server: 'server1',
        operation: 'create',
        // No planData set in the node config
        wires: [['n2']],
      },
      { id: 'n2', type: 'helper' },
    ];
    ...
    // Reset createMealPlan stub to return specific data
    mockClient.mealPlans.createMealPlan = sinon.stub().resolves({
      id: 'plan-999',
      date: '2025-05-11',
      title: 'Sunday Plan',
    ...
    helper.load([rewiredPlanningNode, configNode], flow, function () {
      ...
      n2.on('input', function (msg) {
        try {
          ...
          msg.payload.should.have.property('operation', 'create');
          msg.payload.should.have.property('data');
          msg.payload.data.should.have.property('id', 'plan-999');
          msg.payload.data.should.have.property('date', '2025-05-11');
          msg.payload.data.should.have.property('title', 'Sunday Plan');
          msg.payload.data.should.have.property('meals');
      ...
      // Trigger the node with planData in the payload
      n1.receive({
        payload: {
          planData: planData,
        },
      ...
      n2.on('input', function (msg) {
        try {
          ...
          msg.payload.error.should.have.property(
            'message',
            'No plan data provided for create operation. Specify in node config or msg.payload.planData',
          );
  ...
  it('should handle API errors gracefully', function (done) {
    ...
    // Make the createMealPlan stub throw an error
    mockClient.mealPlans.createMealPlan = sinon.stub().rejects(new Error('Invalid recipe ID'));
    ...
    helper.load([rewiredPlanningNode, configNode], flow, function () {
      ...
      n2.on('input', function (msg) {
        try {
          ...
          msg.payload.should.have.property('operation', 'create');
          msg.payload.should.have.property('error');
          msg.payload.error.should.have.property('message', 'Invalid recipe ID');
